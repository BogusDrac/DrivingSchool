...
import img from "../assets/images/vehiclecontrols/lightmotor.jpg"
  ...
  return (
    <div className="min-h-screen bg-white p-6 select-none">
        <Link to="/vehicle-controls" className="text-yellow-500 hover:text-yellow-600 transition-colors duration-300">
            <button 
                className="flex items-center gap-2 mb-6 px-4 py-2  text-amber-400 rounded-lg hover:scale-105 transition-colors"
            >
                <ArrowLeft size={20} />
                Back
            </button>
      ...
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-black">Light Motor Vehicle Controls</h1>
