...
import { Star, StarHalf, Send, Award, Clock } from 'lucide-react';
  ...
  const ReviewCard = memo(({ review }) => (
    <div 
      className="bg-white rounded-lg shadow-xl overflow-hidden border border-yellow-500/30 p-6 
        transform transition-all duration-500 hover:scale-102 hover:shadow-2xl"
    >
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-24 select-none">
      <div className="container mx-auto px-4 py-8">
        {/* Header Section */}
        <h2 className="text-3xl font-bold text-gray-900 relative mb-8">
          Student Reviews
        </h2>
        ...
        <button
          ...
          className="fixed top-24 right-8 bg-green-600 text-white rounded-full w-16 h-16 flex items-center justify-center shadow-lg hover:bg-green-700 transition-all duration-300 hover:scale-110"
        >
            ...
            <div className="bg-white rounded-lg shadow-2xl border border-yellow-500/30 p-6 max-w-2xl w-full max-h-screen overflow-y-auto md:max-h-[90vh]">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex gap-4">
                  <button
                    type="submit"
                    className="flex-1 bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 focus:ring-2 focus:ring-red-400 shadow-lg flex items-center justify-center gap-2"
                  >
